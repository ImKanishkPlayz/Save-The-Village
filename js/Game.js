class Game {
  ...
  play(){
    ...
    if(fireballFlag === false && villainFlag === false){
      textSize(50);
      fill("black");
      text("You Won!", width/2 - 70, height/2 - 70);
    ...
    if(gameOverFlag === true){
      textSize(50);
      fill("black");
      text("GAME OVER!", width/2 - 120, height/2 - 120);
